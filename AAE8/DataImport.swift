...
class CCriteriaStore {
    ...
    func loadFile() {
        ...
        let cCriteriaList = loadCCriteria(fromCSV: "LabCriteria_ver 4_new14_edited")
...
class MeaningStore {
    ...
    func loadFile() {
        // CSV 파일 이름 (확장자는 .csv 생략)
        let meaningList = loadMeaning(fromCSV: "Meaning_ver 4_new14_edited")
...
class DiseaseStore {
    ...
    func loadFile() {
        // CSV 파일 이름 (확장자는 .csv 생략)
        let diseaseList = loadDisease(fromCSV: "Disease_ver 4_new14_edited")
